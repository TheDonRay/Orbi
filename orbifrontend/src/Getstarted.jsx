...
function Getstarted() {
  ...
  async function onSubmitfromUser(e) {
    // the e here stands for even tobject that the broswer passes to event handlers when something happens like a form submission a click or key press
    ...
    try {
      // error that i faced was i didnt pass the entire backend route here to that specific endpoint
    ...
    <>
      <div className="divstyle">
        <Card className="cardstyle">
          <h3 className="text">
            Enter your <span className="namecolor">Name</span> and{" "}
      ...
      <div className="seconddivstyle">
        <Card className="secondcard">
          <h3 className="text">
            Enter the day you'd like your{" "}
            <span className="namecolor">email</span> sent{" "}
            <span className="emailcolor">to you!</span>
          </h3>
